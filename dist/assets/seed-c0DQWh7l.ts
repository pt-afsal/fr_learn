...
export const seedTopics: SkillTopic[] = [
  ...
  },
  {
    ...
    explanationEn: 'Passé composé describes completed actions using avoir or être plus a past participle. Most verbs use avoir; movement/change verbs and reflexive verbs use être.',
    explanationFr: 'Le passé composé exprime des actions terminées avec avoir ou être plus un participe passé. La plupart des verbes utilisent avoir ; les verbes de déplacement, de changement d’état et les verbes pronominaux utilisent être.',
...
seedTopics.push(...extraTopics, ...bookA2Topics, ...bookB1Topics, ...a2B1Topics)
